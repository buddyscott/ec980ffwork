...
playercontracts <- read_excel("bbrefcontractdata.xlsx")
...
ggplot(aes(x = currentwinpct, y = valuation, label = team)) + 
  ...
  annotate(x=0.5, y=3.5, label=paste("Correlation = ", 
                                     round(cor(nbainfo$currentwinpct, 
                                               nbainfo$valuation), 3)), 
           geom="text", size=5) + 
  labs(title = "Team Valuation vs. 2019-2020 Winning Percentage",
...
ggplot(aes(x = tenyrwinpct, y = valuation, label = team)) + 
  ...
  annotate(x=0.5, y=3.5, label=paste("Correlation = ", 
                                     round(cor(nbainfo$tenyrwinpct, 
                                               nbainfo$valuation), 3)), 
         geom="text", size=5) + 
  labs(title = "Team Valuation vs. Ten Year Winning Percentage",
